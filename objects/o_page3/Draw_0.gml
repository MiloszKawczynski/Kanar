...
draw_sprite_ext(s_symbol,global.symbol,x+left_page-80+string_width("Symbol: "),y+110,2,2,0,c_white,1);

draw_text(x+left_page-110,y+150,"Code:");
draw_text(x+left_page-110+string_width("Code: "),y+150,global.code);